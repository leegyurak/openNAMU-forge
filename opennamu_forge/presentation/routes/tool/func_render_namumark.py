...
class class_do_render_namumark:
    ...
    def get_tool_data_restore(self, data, do_type = 'all'):
        ...
        while 1:
            if not re.search(storage_regex, data):
                break
            if storage_count < 0:
                logger.error('Error : render restore count overflow')
    ...
    def get_tool_footnote_make(self):    
        ...
        for for_a in self.data_footnote:
            if data == '':
                data += '<div class="opennamu_forge_footnote">'
            else:
    ...
    def do_render_heading(self):
        ...
        while 1:
            ...
            if not heading_data:
                ...
                logger.error('Error : render heading count overflow')
                ...
                if heading_data_diff != heading_data_last:
                    ...
                    data_name = self.get_tool_data_storage(
                        '<h' + heading_level_str + '><span id="' + self.doc_set['doc_include'] + 'opennamu_forge_heading_' + str(heading_count) + '_sub" style="opacity: ' + heading_folding[2] + '">', 
                            ' <sub>' + \
                                '<a href="javascript:void(0);" onclick="javascript:opennamu_forge_heading_folding(\'' + self.doc_set['doc_include'] + 'opennamu_forge_heading_' + str(heading_count) + '\', this);">' + \
                                    heading_folding[0] + \
                                '</a>'
                            '</sub>' + \
                    ...
                    heading_data_complete = '' + \
                        ...
                        '<' + data_name + '>' + \
                            ...
                            ' ' + heading_data_text + \
                        '</' + data_name + '>' + \
                        '<div id="' + self.doc_set['doc_include'] + 'opennamu_forge_heading_' + str(heading_count) + '" style="display: ' + heading_folding[1] + ';">' + \
                        '<back_br>\n' + \
                    ''
        ...
        if len(toc_list) == 0:
            ...
            toc_data = '' + \
                '<div class="opennamu_forge_TOC" id="toc">' + \
                    '<span class="opennamu_forge_TOC_title">' + self.get_tool_lang('toc') + '</span>' + \
                    '<br>' + \
                ''
    ...
    def do_render_macro(self):
        ...
        def do_render_macro_double(match):
            ...
            if name_data in ('youtube', 'nicovideo', 'navertv', 'kakaotv', 'vimeo', 'instagram', 'twitter', 'tiktok', 'facebook'):
                ...
                data_name = self.get_tool_data_storage('<span class="' + ('opennamu_forge_render_ip' if render == 1 else '') + '">' + user_name + '</span>', '', match_org.group(0))
                ...
                data_name = self.get_tool_data_storage('<span class="opennamu_forge_joke">', '</span>', match_org.group(0))
    ...
    def do_render_math(self):
        def do_render_math_sub(match):
            ...
            name_ob = self.doc_set['doc_include'] + 'opennamu_forge_math_' + str(self.data_math_count)
    ...
    def do_render_link(self):
        ...
        while 1:
            ...
            if not link_data:
                ...
                logger.error('Error : render link count overflow')
                break
            else:
                # link split
                    ...
                    if link_exist != '':
                        ...
                        if file_pass == 1:
                            ...
                            if image_set == 'new_click':
                                data_name = self.get_tool_data_storage('<a title="' + link_sub + '" id="opennamu_forge_image_' + str(image_count) + '_link" href="javascript:void(0);">' + file_end, '</a>', link_data_full)
                                self.render_data_js += '''
                                    document.getElementById("opennamu_forge_image_''' + str(image_count) + '''_link").addEventListener("click", function(e) {
                                        document.getElementById("opennamu_forge_image_''' + str(image_count) + '''").src = "''' + self.get_tool_js_safe(link_main) + '''";
                                        setTimeout(function() {
                                            document.getElementById("opennamu_forge_image_''' + str(image_count) + '''_link").href = "''' + self.get_tool_js_safe(file_link) + '''";
                                        }, 100);
                                    });\n
                                '''
                                image_count += 1
                ...
                # category
                    ...
                    if re.search(r'#blur$', link_main, flags = re.I):
                        ...
                        category_blur = 'opennamu_forge_category_blur'
                    ...
                    if not link_main in self.data_category_list:
                        ...
                        if self.data_category == '':
                            self.data_category = '' + \
                                '<div class="opennamu_forge_category" id="cate">' + \
                                    '<a class="opennamu_forge_category_button" href="javascript:opennamu_forge_do_category_spread();"> (+)</a>' + \
                ...
                # in link
                    ...
                    if link_main == self.doc_name:
                        link_same = 'opennamu_forge_same_link'
            ...
            if include_count_max < 0:
                ...
                if self.doc_set['doc_type'] == "include":
                    ...
                    if db_data:
                        ...
                        include_link = '<a class="opennamu_forge_not_exist_link" href="/w/' + url_pas(include_name) + '">(' + include_name_org + ')</a>'
                ...
                if footnote_data[2]:
                    ...
                    if footnote_set == 'spread':
                        data_name = self.get_tool_data_storage(
                            ...
                            '</sup>' + \
                            '<span class="opennamu_forge_spead_footnote" id="' + rfn + '_load" style="display: none;"></span>',
                            '',
                            footnote_data_org
                        )
                        self.render_data_js += 'document.getElementById("' + rfn + '").addEventListener("click", function() { opennamu_forge_do_footnote_spread("' + rfn + '", "' + fn + '"); });\n'
                        ...
                        data_name = self.get_tool_data_storage(
                            '<span id="' + rfn + '_over">' + \
                                '<sup>' + \
                                    '<a fn_target="' + fn + '" id="' + rfn + '" href="javascript:void(0);">(' + foot_v_name + ')</a>' + \
                                '</sup>' + \
                                '<span class="opennamu_forge_popup_footnote" id="' + rfn + '_load" style="display: none;"></span>' + \
                            '</span>',
                            '',
                            footnote_data_org
                        )
                        self.render_data_js += 'document.getElementById("' + rfn + '_over").addEventListener("click", function() { opennamu_forge_do_footnote_popover("' + rfn + '", "' + fn + '", undefined, "open"); });\n'
                        self.render_data_js += 'document.addEventListener("click", function() { opennamu_forge_do_footnote_popover("' + rfn + '", "' + fn + '", undefined, "close"); });\n'
                    else:
    ...
    def do_render_table(self):
        ...
        while 1:
            ...
            if table_count_all < 0:
                logger.error('Error : render table count overflow')
    ...
    async def do_render_middle(self):
            ...
            if middle_count_all < 0:
                ...
                if middle_name:
                    ...
                    if middle_name == "#!if":
                        ...
                        self.render_data_js += 'opennamu_forge_do_render_html("' + self.doc_set['doc_include'] + 'opennamu_forge_wiki_' + str(html_count) + '");\n'

                        data_name = self.get_tool_data_storage('<span id="' + self.doc_set['doc_include'] + 'opennamu_forge_wiki_' + str(html_count) + '">' + data_revert, '</span>', middle_data_org)
                        html_count += 1
                        ...
                        data_name = self.get_tool_data_storage('<details><summary>', '</summary><div class="opennamu_forge_folding">', middle_data_org)
                        ...
                        if wiki_data.count('\n') > 10:
                            self.render_data_js += 'hljs.lineNumbersBlock(document.getElementById("opennamu_forge_syntax_' + str(syntax_count) + '"));\n'

                        data_name = self.get_tool_data_storage('<pre id="syntax"><code class="' + wiki_data_syntax + '" id="opennamu_forge_syntax_' + str(syntax_count) + '">' + wiki_data, '</code></pre>', middle_data_org)
        ...
        class do_render_middle_replace_inter_class:
            ...
            async def replace(self, match):
                ...
                data = await self.do_inter_render(data, self.doc_set['doc_include'] + 'opennamu_forge_inter_render_' + str(self.inter_count))
    ...
    async def do_render_list(self):
        ...
        while 1:
            ...
            if quote_count_max < 0:
                ...
                quote_data_end = await self.do_inter_render(quote_data, self.doc_set['doc_include'] + 'opennamu_forge_quote_' + str(quote_count))
        ...
        list_style = {
            ...
            2 : 'opennamu_forge_list_2',
            3 : 'opennamu_forge_list_3',
            4 : 'opennamu_forge_list_4'
        }
        class do_render_list_int_to:
            ...
            def __call__(self, match):
                if match.group(4):
                    ...
                    list_style_data = 'opennamu_forge_list_5'
                    ...
                    return '<li style="margin-left: ' + str((list_len - 1) * 20) + 'px;" class="opennamu_forge_list_none">' + change_text + '. ' + list_data + '</li>'
