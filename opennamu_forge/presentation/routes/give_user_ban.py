...
async def give_user_ban(name = None, ban_type = ''):
    ...
    if flask.request.method == 'POST':
        ...
        if ban_type == 'multiple':
            ...
            n_name = '<textarea class="opennamu_forge_textarea_500 __ON_TEXTAREA__" placeholder="' + await get_lang('name_or_ip_or_regex_or_cidr_multiple') + '" name="name"></textarea><hr class="main_hr">'
        else:
